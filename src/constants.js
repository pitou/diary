...
export const PAGE_BORDER_MAX_RADIUS = 5

export const PAGE_WIDTH = 40
export const PAGE_HEIGHT = (PAGE_WIDTH * PAPER_PAGE_H) / PAPER_PAGE_W
export const PAGE_HEIGHT_PLUS_GAP = PAGE_HEIGHT + 40
export const PAGE_PADDING_TOP = 6
export const PAGES_GAP = 6
